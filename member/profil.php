            ...
            <form action="profil_edit.php" method="POST" class="form-horizontal" accept-charset="utf-8">
              ...
              <input type="text" name="idu" style="display: none;" value="<?php  echo $data['idu']; ?>" placeholder="">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                  <input class="form-control datepicker" id="tl" type="text" value="<?php  echo date('d-m-Y',strtotime($data['tgl_lahir'])) ?>" name="tgl_lahir" required="">                  
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                  <input disabled="active" class="form-control" type="text" id="tlexp" value="<?php echo date('d-m-y',strtotime($data['tgl_exp'])) ?>" name="tempo">
                  </div>
                </div>
                <div class="form-group">
                  <label for="Status" class="col-md-3">Aktifitas </label>
                  <div class="col-md-9">
                  <select class="form-control" name="status" disabled="active">
                ...
                <a href="index.php" title="Back" class="btn btn-warning btn-sm btn-flat pull-right" style="margin: 3px;">Batal</a>
