        ...
        <?php
          ...
          while ($a = mysqli_fetch_array ($query)){ ?>
            <tr>
              ...
              <div class="col-md-7">
              <br><br><a href="../instruktur/index.php?page=d_artikel&id=<?php echo $a['id_artikel']; ?>"><h3 align="justify" style="padding:0 10px;font-size: 14pt; font-family: impact;"><?php echo $a['judul_artikel']; ?></h3></a>
              <div class="clearfix">
              ...
              <p class="read-more"><a href="../instruktur/index.php?page=d_artikel&id=<?php echo $a['id_artikel']; ?>" class="button button1 pull-right">Baca Lengkap</a></p>
              </div>
              </div>
              </section>
              </td>
